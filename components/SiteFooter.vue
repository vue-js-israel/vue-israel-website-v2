<script></script>
<template>
    <footer class="h-60 min-h-fit border-b-light-bg-lightest dark:border-t-dark-bg-dark border-t-2">
        <div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
            <ul
                ...
                <li class="flex">
                    <NuxtLink class="flex items-center px-4 -mb-1 text-light-text-dark dark:text-dark-text-lighter hover:text-cta-hover" to="/events">Events
                    </NuxtLink>
                </li>
                <li class="flex">
                    <NuxtLink class="flex items-center px-4 -mb-1 text-light-text-dark dark:text-dark-text-lighter hover:text-cta-hover" to="/speakers">
                        Speakers
                    </NuxtLink>
                </li>
            </ul>
            <div class="flex flex-col justify-center pt-6 lg:pt-0">
                <div class="flex justify-center space-x-4">
                    <a rel="noopener noreferrer" href="https://www.facebook.com/officalVuejsIsrael/" target="_blank"
                        ...
                        class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10  text-light-text-dark dark:text-dark-text-lighter hover:text-cta-hover">
