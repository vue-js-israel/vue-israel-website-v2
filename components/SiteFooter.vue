<script></script>
<template>
    <footer class="h-60 min-h-fit bg-light-second dark:bg-dark-second text-dark-second dark:text-light-second">
            ...
            <div class="flex flex-col justify-center pt-6 lg:pt-0">
                <div class="flex justify-center space-x-4">
                    <a rel="noopener noreferrer" href="https://www.facebook.com/officalVuejsIsrael/" target="_blank"
                        ...
                        class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-lighter dark:text-gray-900">
