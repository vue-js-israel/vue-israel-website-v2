...
<template>
  <header class="max-h-24 min-h-fit p-4 border-light-bg-lightest dark:border-dark-bg-dark border-b-2">
    <div v-if="menuToggle"
      ...
      <button @click.prevent="onMenuClose" class="flex justify-end p-4 md:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-14 w-14">
    ...
    <div class="container mx-auto flex h-16 justify-between">
      ...
      <ul class="hidden items-stretch space-x-3 md:flex">
        <li class="flex">
          <NuxtLink class="-mb-1 flex items-center border-b-2 px-4 dark:border-transparent link" to="/events">Events
          </NuxtLink>
        </li>
        <li class="flex">
          <NuxtLink class="-mb-1 flex items-center border-b-2 px-4 dark:border-transparent link" to="/speakers">Speakers
          </NuxtLink>
        </li>
      </ul>
